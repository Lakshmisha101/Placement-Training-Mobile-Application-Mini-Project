...
public class OnlineTest3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_online_test3);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (optionsRadioGroup.getCheckedRadioButtonId() != -1) {
                    ...
                    Toast.makeText(OnlineTest3.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void setupQuestions() {
        ...
        OnlineTest3.Question question4 = new OnlineTest3.Question("Question:4\n" +
        ...
        OnlineTest3.Question question2 = new OnlineTest3.Question("Question:2\n" +
        ...
        OnlineTest3.Question question3 = new OnlineTest3.Question("Question:3\n" +
                "#include <stdio.h>\n" +
                "\n" +
                "int main() {\n" +
                "   int i = 5;\n" +
        ...
        OnlineTest3.Question question1 = new OnlineTest3.Question("Question:1\n" +
        ...
        OnlineTest3.Question question8 = new OnlineTest3.Question("Question:8\n" +
        ...
        OnlineTest3.Question question9 = new OnlineTest3.Question("Question:9\n" +
                "Which SQL keyword is used to retrieve data from a database table?", "INSERT", " UPDATE", "SELECT", "DELETE", "SELECT");
        questions.add(question9);

        OnlineTest3.Question question10 = new OnlineTest3.Question("Question:10\n" +
        ...
        OnlineTest3.Question question11= new OnlineTest3.Question("Question:11\n" +
        ...
        OnlineTest3.Question question12 = new OnlineTest3.Question("Question:12\n" +
        ...
        OnlineTest3.Question question13 = new OnlineTest3.Question("Question:13\n" +
        ...
        OnlineTest3.Question question14 = new OnlineTest3.Question("Question:14\n" +
                "#include <stdio.h>\n" +
                "\n" +
                "int main() {\n" +
                "   int i = 5;\n" +
        ...
        OnlineTest3.Question question15 = new OnlineTest3.Question("Question:15\n" +
