...
public class Networking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvHiddenContent1 = findViewById(R.id.tvNetworkingHiddenContent1);
        btnToggle1= findViewById(R.id.NetworkingbtnToggle1);
    ...
    private void toggleContentVisibility1() {
        ...
        tvHiddenContent2 = findViewById(R.id.tvNetworkingHiddenContent2);
        btnToggle2= findViewById(R.id.NetworkingbtnToggle2);
    ...
    private void toggleContentVisibility2() {
        ...
        tvHiddenContent3 = findViewById(R.id.tvNetworkingHiddenContent3);
        btnToggle3= findViewById(R.id.NetworkingbtnToggle3);
    ...
    private void toggleContentVisibility3() {
        ...
        tvHiddenContent4 = findViewById(R.id.tvNetworkingHiddenContent4);
        btnToggle4= findViewById(R.id.NetworkingbtnToggle4);
    ...
    private void toggleContentVisibility4() {
        ...
        tvHiddenContent5 = findViewById(R.id.tvNetworkingHiddenContent5);
        btnToggle5= findViewById(R.id.NetworkingbtnToggle5);
    ...
    private void toggleContentVisibility5() {
        ...
        tvHiddenContent6 = findViewById(R.id.tvNetworkingHiddenContent6);
        btnToggle6= findViewById(R.id.NetworkingbtnToggle6);
    ...
    private void toggleContentVisibility6() {
        ...
        tvHiddenContent7 = findViewById(R.id.tvNetworkingHiddenContent7);
        btnToggle7= findViewById(R.id.NetworkingbtnToggle7);
    ...
    private void toggleContentVisibility7() {
        ...
        tvHiddenContent8 = findViewById(R.id.tvNetworkingHiddenContent8);
        btnToggle8= findViewById(R.id.NetworkingbtnToggle8);
    ...
    private void toggleContentVisibility8() {
        ...
        tvHiddenContent9 = findViewById(R.id.tvNetworkingHiddenContent9);
        btnToggle9= findViewById(R.id.NetworkingbtnToggle9);
    ...
    private void toggleContentVisibility9() {
        ...
        tvHiddenContent10 = findViewById(R.id.tvNetworkingHiddenContent10);
        btnToggle10= findViewById(R.id.NetworkingbtnToggle10);
