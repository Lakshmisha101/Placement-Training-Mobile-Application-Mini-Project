...
public class OnlineTest2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_online_test2);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (optionsRadioGroup.getCheckedRadioButtonId() != -1) {
                    ...
                    Toast.makeText(OnlineTest2.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void setupQuestions() {
        ...
        OnlineTest2.Question question1 = new OnlineTest2.Question("Question:1\n" +
        ...
        OnlineTest2.Question question2 = new OnlineTest2.Question("Question:2\n" +
        ...
        OnlineTest2.Question question3 = new OnlineTest2.Question("Question:3\n" +
                "#include <stdio.h>\n" +
                "\n" +
                "int main() {\n" +
                "   int i = 5;\n" +
        ...
        OnlineTest2.Question question4 = new OnlineTest2.Question("Question:4\n" +
        ...
        OnlineTest2.Question question8 = new OnlineTest2.Question("Question:8\n" +
        ...
        OnlineTest2.Question question9 = new OnlineTest2.Question("Question:9\n" +
                "Which SQL keyword is used to retrieve data from a database table?", "INSERT", " UPDATE", "SELECT", "DELETE", "SELECT");
        questions.add(question9);

        OnlineTest2.Question question10 = new OnlineTest2.Question("Question:10\n" +
        ...
        OnlineTest2.Question question11= new OnlineTest2.Question("Question:11\n" +
        ...
        OnlineTest2.Question question12 = new OnlineTest2.Question("Question:12\n" +
        ...
        OnlineTest2.Question question13 = new OnlineTest2.Question("Question:13\n" +
        ...
        OnlineTest2.Question question14 = new OnlineTest2.Question("Question:14\n" +
                "#include <stdio.h>\n" +
                "\n" +
                "int main() {\n" +
                "   int i = 5;\n" +
        ...
        OnlineTest2.Question question15 = new OnlineTest2.Question("Question:15\n" +
