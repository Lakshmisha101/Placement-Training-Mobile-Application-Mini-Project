    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CProgramming.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Programming.this,CProgramming.class));
            }
        });
        ...
        C_Programming.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Programming.this,CPPProgramming.class));
            }
        });
        ...
        Java_Programming.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Programming.this,JavaProgramming.class));
            }
        });
        ...
        ProgrammingTest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Programming.this,ProgrammingTests.class));
            }
        });
    }
}