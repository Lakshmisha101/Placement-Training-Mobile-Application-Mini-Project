...
public class VerbalReasonings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verbal_reasonings);
        tvHiddenContent1 = findViewById(R.id.tvLogicalReasoningContent1);
        btnToggle1= findViewById(R.id.LogicalReasoningbtnToggle1);
    ...
    private void toggleContentVisibility1() {
        ...
        tvHiddenContent2 = findViewById(R.id.tvLogicalReasoningContent2);
        btnToggle2= findViewById(R.id.LogicalReasoningbtnToggle2);
    ...
    private void toggleContentVisibility2() {
        ...
        tvHiddenContent3 = findViewById(R.id.tvLogicalReasoningContent3);
        btnToggle3= findViewById(R.id.LogicalReasoningbtnToggle3);
    ...
    private void toggleContentVisibility3() {
        ...
        tvHiddenContent4 = findViewById(R.id.tvLogicalReasoningContent4);
        btnToggle4= findViewById(R.id.LogicalReasoningbtnToggle4);
    ...
    private void toggleContentVisibility4() {
        ...
        tvHiddenContent5 = findViewById(R.id.tvLogicalReasoningContent5);
        btnToggle5= findViewById(R.id.LogicalReasoningbtnToggle5);
    ...
    private void toggleContentVisibility5() {
        ...
        tvHiddenContent6 = findViewById(R.id.tvLogicalReasoningContent6);
        btnToggle6= findViewById(R.id.LogicalReasoningbtnToggle6);
    ...
    private void toggleContentVisibility6() {
        ...
        tvHiddenContent7 = findViewById(R.id.tvLogicalReasoningContent7);
        btnToggle7= findViewById(R.id.LogicalReasoningbtnToggle7);
    ...
    private void toggleContentVisibility7() {
        ...
        tvHiddenContent8 = findViewById(R.id.tvLogicalReasoningContent8);
        btnToggle8= findViewById(R.id.LogicalReasoningbtnToggle8);
    ...
    private void toggleContentVisibility8() {
        ...
        tvHiddenContent9 = findViewById(R.id.tvLogicalReasoningContent9);
        btnToggle9= findViewById(R.id.LogicalReasoningbtnToggle9);
    ...
    private void toggleContentVisibility9() {
        ...
        tvHiddenContent10 = findViewById(R.id.tvLogicalReasoningContent10);
        btnToggle10= findViewById(R.id.LogicalReasoningbtnToggle10);
