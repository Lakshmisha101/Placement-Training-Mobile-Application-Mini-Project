...
public class DatabaseQ extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_database_q);
        tvHiddenContent1 = findViewById(R.id.tvDatabaseQHiddenContent1);
        btnToggle1= findViewById(R.id.DatabaseQbtnToggle1);
    ...
    private void toggleContentVisibility1() {
        ...
        tvHiddenContent2 = findViewById(R.id.tvDatabaseQHiddenContent2);
        btnToggle2= findViewById(R.id.DatabaseQbtnToggle2);
    ...
    private void toggleContentVisibility2() {
        ...
        tvHiddenContent3 = findViewById(R.id.tvDatabaseQHiddenContent3);
        btnToggle3= findViewById(R.id.DatabaseQbtnToggle3);
    ...
    private void toggleContentVisibility3() {
        ...
        tvHiddenContent4 = findViewById(R.id.tvDatabaseQHiddenContent4);
        btnToggle4= findViewById(R.id.DatabaseQbtnToggle4);
    ...
    private void toggleContentVisibility4() {
        ...
        tvHiddenContent5 = findViewById(R.id.tvDatabaseQHiddenContent5);
        btnToggle5= findViewById(R.id.DatabaseQbtnToggle5);
    ...
    private void toggleContentVisibility5() {
        ...
        tvHiddenContent6 = findViewById(R.id.tvDatabaseQHiddenContent6);
        btnToggle6= findViewById(R.id.DatabaseQbtnToggle6);
    ...
    private void toggleContentVisibility6() {
        ...
        tvHiddenContent7 = findViewById(R.id.tvDatabaseQHiddenContent7);
        btnToggle7= findViewById(R.id.DatabaseQbtnToggle7);
    ...
    private void toggleContentVisibility7() {
        ...
        tvHiddenContent8 = findViewById(R.id.tvDatabaseQHiddenContent8);
        btnToggle8= findViewById(R.id.DatabaseQbtnToggle8);
    ...
    private void toggleContentVisibility8() {
        ...
        tvHiddenContent9 = findViewById(R.id.tvDatabaseQHiddenContent9);
        btnToggle9= findViewById(R.id.DatabaseQbtnToggle9);
    ...
    private void toggleContentVisibility9() {
        ...
        tvHiddenContent10 = findViewById(R.id.tvDatabaseQHiddenContent10);
        btnToggle10= findViewById(R.id.DatabaseQbtnToggle10);
